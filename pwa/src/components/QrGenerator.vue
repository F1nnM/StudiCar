        ...
        <q-card-section class="text-center overflow-hidden-y q-pa-none">
          <div class="bg-white text-center">
            ...
            <img src="~assets/app-icon.svg" />
              ...
              <q-tab-panel name="raw" class="q-mt-xs">
            ...
            <div class="q-px-md text-caption text-center">
              <q-tabs
                v-model="dataTab"
                dense
                ...
                narrow-indicator
              >
                <q-tab :ripple="false" name="qr" label="QR Code" />
                <q-tab :ripple="false" name="raw" label="Link" />
              </q-tabs>
