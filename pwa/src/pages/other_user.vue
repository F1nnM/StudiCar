<template>
  <div class="q-pa-md">
    <div class="q-gutter-y-md" style="max-width: 600px">
      <div class="text-h6">Profil von {{user.first_name}}</div>
      <hr />
      <br />
      <p></p>
    </div>
...
data(){
  return{
    user:{
        ...
        first_name: 'Herbert',
        surname: 'Müller',
        picture: 'https://cdn.quasar.dev/img/avatar2.jpg',
        course: 'FKS15',
        adress: {
            street: 'Musterstraße',
            number: 13,
        ...
        cars: [
            ...
            },
            {
                ...
                model: 'Punto',
                type: 'Kleinwagen',
                number_plate: 'M-FP-007',
                seats: 4
            }
        ],
        preferences:{
            talkativeness: 'green',
            talkativeness_morning: 'yellow',
            smoking: true,
            music: 'green'
        },
        bio: 'Bin der Herbert und freu mich auf die nächste Fahrt',
        created: 1568618642779,
        activity: 4,
        mail: 'herbert@domain.com'
        }
    }
  }
}
